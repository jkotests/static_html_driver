...
RSpec.describe 'Browser' do
	...
	describe '#element' do
		...
		it 'finds an element using regexp values' do
			# XPath generated by https://github.com/watir/watir/blob/master/lib/watir/locators/element/locator.rb#L208
			# is not valid in Nokogiri
			aggregate_failures do
				expect(browser.element(class: /Class/)).to exist
				expect(browser.h1(class: /Class/, id: /head/)).to exist
				expect(browser.h1(text: /Header/)).to exist
				expect(browser.link(href: /example/)).to exist
				expect(browser.h1(id: 'header', class: /header/)).to exist
			end
		end
	end
